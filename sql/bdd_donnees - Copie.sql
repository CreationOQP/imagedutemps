...
liés la base produit avec la base image et avis
						
						
		SELECT produits.pro_id, produits.pro_designation, images.img_filename, images.img_designation FROM produits INNER JOIN images ON produits.pro_id = images.img_pro_id;

		SELECT produits.pro_id, produits.pro_designation, avis.avi_avis, avis.avi_date FROM produits INNER JOIN avis ON produits.pro_id = avis.avi_pro_id;
		
		SELECT produits.pro_id, produits.pro_designation, images.img_filename, images.img_designation, avis.avi_avis, avis.avi_date
		FROM produits
		INNER JOIN images ON produits.pro_id = images.img_pro_id
		INNER JOIN avis ON produits.pro_id = avis.avi_pro_id;
