...
-- création de la table diapositive, préfixe dia. --
	CREATE TABLE Diapositive (								-- A_021_
		...
		dia_nom VARCHAR(250),								-- A_021_02
		dia_publication BOOLEAN,							-- A_021_03
		dia_date DATE,										-- A_021_04
		dia_legend VARCHAR(100),							-- A_021_05
		dia_format CHAR(1),									-- A_021_06
		dia_commentaire TEXT,								-- A_021_07
		dia_enregistrement DATE,							-- A_021_08
		dia_epo_annee INT UNSIGNED NOT NULL,				-- A_021_09
		dia_the_id INT UNSIGNED NOT NULL,					-- A_021_10
		dia_lie_id INT UNSIGNED NOT NULL,					-- A_021_11
		dia_typdia_id INT UNSIGNED NOT NULL,				-- A_021_12
		dia_pub_id INT UNSIGNED NOT NULL,					-- A_021_13
		PRIMARY KEY (dia_id))
		ENGINE=INNODB;
...
-- Création de la table connexion IP de tous les visiteurs
	CREATE TABLE ConnexionIP (								-- A_28
		cip_id INT UNSIGNED NOT NULL AUTO_INCREMENT,		-- A_28_01
		cip_adresse varchar(25),							-- A_28_02
		cip_date DATETIME,									-- A_28_02
		PRIMARY KEY (cip_id))
		ENGINE=INNODB;
